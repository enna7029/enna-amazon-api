...
use Enna\AmazonApi\Api\Token\V2021_03_01\TokenApi;
use Enna\AmazonApi\Contract\AuthorizationSignerContract;
use Enna\AmazonApi\Contract\RequestSignerContract;
use Enna\AmazonApi\Model\Token\V2021_03_01\RestrictedResource;
use Enna\AmazonApi\Model\Token\V2021_03_01\CreateRestrictedDataTokenRequest;
...
class Authentication implements RequestSignerContract
{
     ...
     *
     * @return \Enna\AmazonApi\Credentials A set of access credentials for making calls to the SP API
     */
     ...
     *
     * @return \Enna\AmazonApi\Credentials The grantless credentials
     */
     ...
     *
     * @return \Enna\AmazonApi\Credentials A set of STS credentials
     */
     ...
     * @return \Enna\AmazonApi\Credentials A Credentials object holding the RDT
     */
     ...
     *
     * @param ?\Enna\AmazonApi\Credentials $creds The credentials to check
